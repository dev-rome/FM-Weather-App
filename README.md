...
- Solution URL: [Weather App Solution](https://www.frontendmentor.io/solutions/responsive-app-built-with-nextjs-typescript-tailwind-and-api-data-oGdKqlOEuL)
- Live Site URL: [Weather App](fm-weather-app-cyan.vercel.app)
...
- [OpenWeather API](https://openweathermap.org/api) - Geocoding and reverse geocoding
